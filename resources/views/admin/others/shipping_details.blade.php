<div class="page-header">
    <div class="page-title">
        <h4>Physical Store Section</h4>
        <h6>Update Physical Store</h6>
    </div>
</div>

<form class="form-load" type="create" action="{{ route('admin.shippingDetails.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
