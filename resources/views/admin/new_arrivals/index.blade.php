<div class="page-header">
    ...
    <div class="page-btn">
        <a href="#" class="btn btn-added show-modal" hideModal="hide" modalSize="md" modalTitle="Add New Arrivals" modalSize="lg" url="newArrivals/create">
            <img src="{{ asset('admin/assets/img/icons/plus.svg') }}" class="me-1" alt="img">Add New Arrivals
        </a>
    </div>
</div>
                        ...
                        @foreach ($products as $key => $item)
                            <tr class="odd">
                                ...
                                <td class="action text-center">
                                    <a data-id="{{ $item->id }}" url="/newArrivals/{{$item->id}}" class="me-3 confirm-text delete" href="javascript:void(0);">
