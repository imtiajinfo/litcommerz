        ...
        <div class="my-md-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                    ...
                    <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1 active" aria-current="page">{{@$subcategory->subcategory_name}}</li>
                </ol>
            </nav>
        </div>
        <!-- End breadcrumb -->
    ...
    <div class="row mb-8">
        ...
        <div class="col-xl-9 col-wd-9gdot5">
            ...
            <div class="d-block d-md-flex flex-center-between mb-3">
                <h4 class="font-size-25 mb-2 mb-md-0">{{@$subcategory->subcategory_name??@$headTitle}}</h4>
                <p class="font-size-14 text-gray-90 mb-0">
                  Showing {{ @$products->total() }} Products
                  {{-- results of 
                  {{ ($products->currentPage() - 1) * $perPage + 1 }}–
                  <span id="lastTotalCount">
                      {{ min($products->currentPage() * $perPage, $products->total()) }}
                  </span> --}}
              </p>
            </div>
            {{-- product bar start --}}
