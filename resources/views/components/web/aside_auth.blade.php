                ...
                <div class="js-scrollbar u-header-sidebar__footer-offset pb-3">
                    ...
                    <div class="js-scrollbar u-sidebar__body">
                        <div class="u-sidebar__content u-header-sidebar__content">
                            <form id="login-submit" action="{{ route('login.action') }}">
                                @csrf
                                <!-- Login -->
                                <div id="login" data-target-group="idForm">
                                    ...
                                    <div class="mb-2">
                                        <button type="submit" class="btn btn-block btn-sm btn-primary transition-3d-hover" id="login-action-btn">Login</button>
                                    </div>
                            ...
                            <form id="register-submit" action="{{ route('register.action') }}">
                                @csrf
                                <!-- Signup -->
                                <div id="signup" style="display: none; opacity: 0;" data-target-group="idForm">
                                    <!-- Title -->
                                    <header class="text-center mb-7">
                                        <h2 class="h4 mb-0">Welcome to My Daily Shop.</h2>
                                    ...
                                    <div class="form-group">
                                        <div class="js-form-message js-focus-state">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="name" id="register-name" placeholder="Name" aria-label="Name" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="js-form-message js-focus-state">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="password" class="form-control" name="confirmed" id="signupConfirmPassword" placeholder="Confirm Password">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- End Input -->
                                    ...
                                    <div class="mb-2">
                                        <button type="submit" class="btn btn-block btn-sm btn-primary transition-3d-hover" id="register-action-btn">Get Started</button>
                                    </div>
