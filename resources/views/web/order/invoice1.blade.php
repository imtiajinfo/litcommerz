    ...
    <div class="invoice-container">
        ...
        @if(@$type != 'pdf')
            <div class="no-print" style="margin-bottom:10px;">
                ...
                <a class="print-button" href="/orders" style="text-decoration: none;">Order List</a>
            </div>
        @endif
        ...
        <table class="header-table">
            <tr>
                ...
                <td style="width:33%; vertical-align:middle; text-align:right;">
                    <div class="support">Customer Support:<br>090-6476-4347</div>
                </td>
            </tr>
        </table>
        ...
        <table class="header-table">
            <tr>
                ...
                <td style="width:33%; vertical-align:top; text-align:right;">
                    <div class="info-block">{{$ship->name}}</div>
                    <div class="info-block">{{$ship->address}}, {{$ship->city}}</div>
                    <div class="info-block">{{$ship->phone}}</div>
                </td>
            </tr>
        </table>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                @foreach ($products as $key => $item)
                    @php
                        $unitPrice = $item->product_price - $item->discount;
